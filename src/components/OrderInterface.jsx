    ...
    <div className='w-4/3 h-1/2 bg-gray-100 rounded ronded-4 mx-16 -mt-6 mb-7 py-2 shadow-lg flex'>
        <div>
            <div onClick={() => {setTikName("Kereta Api")}}>
                <h1 
                className='my-3 bg-white py-3 px-2 font-bold text-pink-600 border-l-4 hover:border-l-8 active:bg-pink-700 hover:bg-pink-500 hover:text-blue-50 border-yellow-400 text-lg px-16'>
